...
public class TableControllerTest {
    ...
    // case: 테이블 카운트 수정하기 (동일하면 수정하지 말자) -> upsert 사용!
    @Test
    public void test_can_upsert_tableCount() throws Exception {
        // given
        int tableCount = 10;
        ...
        // 다시 한 번 수정 ( upsert test )
        int secondTableCount = 20;
        ResultActions secondAction = TableTestUtil.insertTableCount(mvc, businessName, secondTableCount);
        ...
        assertThat(secondTableCounts.get(0).getBusinessName()).isEqualTo(businessName);
        assertThat(secondTableCounts.get(0).getTableCount()).isEqualTo(20);
    }
    ...
    @Test
    public void test_can_retrieve_tableCount_by_userId() throws Exception {
        // given
        int tableCount = 20;
